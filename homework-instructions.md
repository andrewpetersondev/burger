...
- **This assignment must be deployed.** Be sure to utilize the [MYSQL Heroku Deployment Guide](../Student Resource Guide/14-week/MySQLHerokuDeploymentProcess.pdf) in order to deploy your assignment.
...
1. [x] Now you're going to run these SQL files.
